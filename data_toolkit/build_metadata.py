...
if __name__ == "__main__":
    ...
    parser.add_argument("--download_root", type=str, default=None, help="Directory to save the downloaded files")
    parser.add_argument("--thumbnail_root", type=str, default=None, help="Directory to save the thumbnail files")
    parser.add_argument("--render_cond_root", type=str, default=None, help="Directory to save the render condition files")
    parser.add_argument("--mesh_dump_root", type=str, default=None, help="Directory to save the mesh files")
    parser.add_argument("--pbr_dump_root", type=str, default=None, help="Directory to save the pbr files")
    parser.add_argument("--dual_grid_root", type=str, default=None, help="Directory to save the dual grid files")
    parser.add_argument("--pbr_voxel_root", type=str, default=None, help="Directory to save the pbr voxel files")
    parser.add_argument("--ss_latent_root", type=str, default=None, help="Directory to save the sparse structure latent files")
    parser.add_argument("--shape_latent_root", type=str, default=None, help="Directory to save the shape latent files")
    parser.add_argument("--pbr_latent_root", type=str, default=None, help="Directory to save the pbr latent files")
    ...
    parser.add_argument("--from_merged_records", action="store_true", help="Build metadata from merged records")
    parser.add_argument("--record_start", type=int)
    parser.add_argument("--rebuild", action="store_true", help="Rebuild metadata from scratch, ignore existing metadata.")
