...
def _dump_mesh(file_path, metadatum, root):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        args = [
            ...
            "-b",
            "-P",
            os.path.join(os.path.dirname(__file__), "blender_script", "dump_mesh.py"),
            "--",
            "--object",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mesh_dump_root", type=str, default=None, help="Directory to save the mesh dumps")
    parser.add_argument(
    ...
    mesh_dumped = dataset_utils.foreach_instance(
        metadata, opt.download_root, func, max_workers=opt.max_workers, desc="Dumping mesh"
    )
