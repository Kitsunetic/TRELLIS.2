...
if __name__ == "__main__":
    ...
    parser.add_argument("--pbr_dump_root", type=str, default=None, help="Directory to save the pbr dumps")
    ...
    # process objects
    records = []
    with ThreadPoolExecutor(max_workers=opt.max_workers or os.cpu_count()) as executor, tqdm(
        total=len(metadata), desc="Processing objects"
    ) as pbar:
