...
if __name__ == "__main__":
    ...
    parser.add_argument("--download_root", type=str, default=None, help="Directory to download the objects")
    parser.add_argument(
    ...
    parser.add_argument("--check_only", action="store_true", help="Only check if the objects are already downloaded")
